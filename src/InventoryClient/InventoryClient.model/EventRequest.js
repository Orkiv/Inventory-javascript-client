...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['InventoryClient/ApiClient', 'InventoryClient/InventoryClient.model/Dictionary'], factory);
    ...
    root.InventoryClient.EventRequest = factory(root.InventoryClient.ApiClient, root.InventoryClient.Dictionary);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('postbody')) {
        obj['postbody'] = Dictionary.constructFromObject(data['postbody']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:InventoryClient/InventoryClient.model/Dictionary} postbody
   */
