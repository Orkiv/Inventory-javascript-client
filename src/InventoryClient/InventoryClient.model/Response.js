...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.InventoryClient.Response = factory(root.InventoryClient.ApiClient);
  }
   ...
   * @module InventoryClient/InventoryClient.model/Response
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Response</code>.
   * @alias module:InventoryClient/InventoryClient.model/Response
   * @class
   * @extends Object
   */
   ...
   * @param {module:InventoryClient/InventoryClient.model/Response} obj Optional instance to populate.
   * @return {module:InventoryClient/InventoryClient.model/Response} The populated <code>Response</code> instance.
   */
